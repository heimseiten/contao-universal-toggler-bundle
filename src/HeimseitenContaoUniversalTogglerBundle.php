...
namespace Heimseiten\ContaoUniversalTogglerBundle;

use Symfony\Component\HttpKernel\Bundle\Bundle;

/**
 * Class HeimseitenContaoUniversalTogglerBundle
 */
class HeimseitenContaoUniversalTogglerBundle extends Bundle
{
}
